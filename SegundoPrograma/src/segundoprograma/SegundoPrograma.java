 ...
 * @author grgab
 */
public class SegundoPrograma extends javax.swing.JFrame {

    /**
     * Creates new form SegundoPrograma
     */
    ...
    private void initComponents() {
        ...
        lblMensagem.setBackground(new java.awt.Color(0, 153, 255));
        lblMensagem.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        lblMensagem.setForeground(new java.awt.Color(0, 153, 255));
        lblMensagem.setText("Aqui aparecera a mensagem");

        jbnClick.setText("Clique aqui");
        jbnClick.setToolTipText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SegundoPrograma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SegundoPrograma().setVisible(true);
            }
        });
    }
